 ...
 */
final class Version20230126170131 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant CHANGE conversation_id conversation_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant CHANGE conversation_id conversation_id INT NOT NULL');
    }
}
